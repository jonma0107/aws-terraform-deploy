...
Nos dirigimos a nuestras instancias y verificamos que la instancia que se configuró en el archivo `ec2.tf` se haya creado, accedemos a ella y nos desplazamos hasta identificar la dirección IP pública. Más adelante un dominio puede apuntar a esta dirección IP.
